...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-10">
        <ol class="breadcrumb">
            ...
            <li class="active"><span class="fa fa-user"></span> Tambah Data</li>
        </ol>
        <p style="margin-bottom:10px;">
            <strong style="font-size:18pt;"><span class="fa fa-user"></span> Tambah Pengguna</strong>
        </p>
            ...
            <div class="panel-body">
                ...
                <form method="post">
                    <div class="form-group">
                        <label for="np">Nama Lengkap</label>
