<footer class="text-center">2019 - ABSENSI</footer>
	</div>
    ...
    function showStickySuccessToastPassword() {
        $().toastmessage('showToast', {
            text     : 'Sukses, Password Telah Diganti',
            sticky   : true,
            position : 'top-right',
            type     : 'success',
            closeText: '',
    ...
    function showStickyErrorToastExt() {
        $().toastmessage('showToast', {
            text     : 'Ekstensi File Salah! Coba lagi',
            sticky   : true,
            position : 'top-right',
            type     : 'error',
            closeText: '',
    ...
    function showStickyErrorToastMax() {
        $().toastmessage('showToast', {
            text     : 'Ukuran File Terlalu Besar! Coba lagi',
            sticky   : true,
            position : 'top-right',
            type     : 'error',
            closeText: '',
