			  	...
			  	<div style="margin-top: 50px;" class="panel panel-default"><div class="panel-body">
						<form method="POST">
					       <table class="table" style="border: 0px;">
					        <tr>
					          <td colspan="2"><h1>Selamat Datang,</h1></td>
					        </tr>
					          <tr>
					            <td><span class="glyphicon glyphicon-user"></span> Username</td>
					            <td><input id="login-username" type="text" class="form-control" name="username" placeholder="Username" required></td>
					          </tr>
					          <tr>
					            <td><span class="glyphicon glyphicon-lock"></span> Password</td>
					            <td><input id="login-password" type="password" class="form-control" name="password" placeholder="Password" required></td>
					          </tr>
					          <tr>
					            <td></td>
